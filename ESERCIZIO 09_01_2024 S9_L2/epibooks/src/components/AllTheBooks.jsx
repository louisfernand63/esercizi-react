...
export default class AllTheBooks extends Component {
  ...
  componentDidMount() {
    ...
    fetch("../books/fantasy.json").then(response => response.json()).then(json => this.setState({ books: [...this.state.books, ...json] }))

    fetch("../books/history.json").then(response => response.json()).then(json => this.setState({ books: [...this.state.books, ...json] }))

    fetch("../books/horror.json").then(response => response.json()).then(json => this.setState({ books: [...this.state.books, ...json] }))

    fetch("../books/scifi.json").then(response => response.json()).then(json => this.setState({ books: [...this.state.books, ...json] }))
  }
